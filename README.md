...
- 장새벽:팀원들과의 협업을 통해 커뮤니케이션의 중요성을 느꼈습니다. 그리고 API에 대해서 더 공부하고 싶어졌습니다.

- 심연아: 작업을 시작하기 전에 폴더명은 어떻게 할지, 어떻게 구상할지 미리 결정하고 작업한 적이 이번 프로젝트가 처음이라 인상 깊습니다. 이번 프로젝트로 통해 스스로 뭐가 부족한지 느꼈고 잘하는 사람과 같이 할 수 있어서 큰 영광이었습니다. 감사합니다.
